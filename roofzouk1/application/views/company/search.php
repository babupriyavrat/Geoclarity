...
<div class="row">
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="#" onclick="ShowSMSWin(<?php echo $info->contact_id?>, '<?php echo $info->contact_phone?>'); return false;" ><?php echo get_phrase('send_sms');?></a></td>
							</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading"><b><?php echo get_phrase('searched_supervisors');?></b></div>
				<div class="panel-body">
					<table class="table table-bordered">
						<thead>
							<tr>
								...
								<th><?php echo get_phrase('team_size');?></th>
								<th><?php echo get_phrase('email');?></th>
								<th><?php echo get_phrase('home_phone');?></th>
								<th><?php echo get_phrase('office_phone');?></th>
								<th><?php echo get_phrase('mobile_phone');?></th>
								<th><?php echo get_phrase('address');?></th>
							</tr>
						</thead>
						<tbody>
							<?php $idx=0; foreach ($SupList as $info): ?>
							<tr>
								<td><?php echo ++$idx;?></td>
								<td><?php echo $info->supervisor_name?></td>
								<td><?php echo $info->department?></td>
								<td><?php echo $info->teamsize?></td>
								<td><?php echo $info->email?></td>
								<td><?php echo $info->home_phone?></td>
								<td><?php echo $info->office_phone?></td>
