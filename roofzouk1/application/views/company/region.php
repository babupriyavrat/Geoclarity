	...
	<div class="row" style="margin-top:10px;">
		<div class="col-sm-12">
			<table class="table table-bordered" id="table_regions">
					<thead>
						<tr>
							<th><?php echo get_phrase('supervisor_name');?></th>
							<th><?php echo get_phrase('depart');?></th>
					...
					<tbody id="tbody_regions">
						<?php foreach ($supList as $supInfo) {?>
						<tr>
							<td><?php echo $supInfo->supervisor_name?></td>
							<td><?php echo $supInfo->department?></td>
							<td><?php echo $supInfo->cnt?></td>
							<td><?php echo $supInfo->cancelled_count?></td>
							<td><?php echo $supInfo->completed_count?></td>
							<td><?php echo $supInfo->delayed_count?></td>
							<td><?php echo $supInfo->sos_count?></td>
						</tr>
						<?php }?>
					</tbody>
				</table>
