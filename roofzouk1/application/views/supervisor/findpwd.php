                	...
                	<input type="hidden" name="task" value="login" />
						...
						<?php }?>
						 <div class="form-group">
						 	...
						 	<div class="col-sm-8">
						    	<input type="text" class="form-control " id="login_username" name="email" placeholder="SUPERVISOR EMAIL" required>
						    </div>
					  	</div>
					  <div class="form-group">
						 	<div class="col-sm-12">
					  			<input type="submit" class="btn standard-button" value="Submit" />
					  		</div>
					  </div>
                	</form>
