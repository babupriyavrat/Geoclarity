...
for (var i = 0; i < TaskData.length; ++i) {
			...
			if (TaskData[i].SOS_STATUS==='Yes') {
				...
				'<font color="red"><a href="https://www.geoclarity.com/roofzouk/index.php/supervisor/trackuser/'+TaskData[i].user_id+'"> User:' +TaskData[i].user_email +'</a></br></font>'+
				'Actual Start time:'+ TaskData[i].actual_Start + '</br>'+
				'Actual End time:'+ TaskData[i].actual_end + '</br>'+
				//'User ID:'+ TaskData[i].user_id+ '</br>'+
...
<div class="container" style="margin-top:100px;">
	...
	<h3 style="margin-top:0px;text-align:left"><?php echo get_phrase('region');?> : <?php echo $region?>, <?php echo get_phrase('post_code');?> : <?php echo $postcode?></h3>	
	<div class="row">
			...
			<table class="table table-bordered" id="table_regions">
					...
					<tbody id="tbody_regions">
						...
						<tr>
							...
							<td><?php echo $userInfo->cnt?></td>
							<td><?php echo $userInfo->cancelled_count?></td>
							<td><?php echo $userInfo->completed_count?></td>
							<td><?php echo $userInfo->delayed_count?></td>
							<td><?php echo $userInfo->sos_count?></td>
						</tr>
						<?php }?>
					</tbody>
				</table>
