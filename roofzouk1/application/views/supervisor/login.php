                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse" id="stamp-navigation">
                        ...
                        <ul class="nav navbar-nav navbar-right main-navigation  small-text" style="margin-top:20px;margin-right:10px;">
                        	...
                        	<li>
                        	   <b><?php echo get_phrase('sign_in');?> <?php echo get_phrase('or');?> <?php echo get_phrase('sign_up');?></b>
                        	</li>
                        </ul>
                    </div>
                </div>
                	...
                	<input type="hidden" name="task" value="login" />
						...
						<?php }?>
						 ...
						 <div class="form-group">
						 	...
						 	<div class="col-sm-8">
						    	<input type="text" class="form-control " id="login_username" name="email" placeholder="<?php echo get_phrase('supervisor_email');?>" required>
						    </div>
					  	</div>
					  <div class="form-group">
					  	<label class="col-sm-4 control-label"><?php echo get_phrase('password');?></label>
					  	<div class="col-sm-8">
					    	<input type="password" class="form-control" id="login_pwd" name="pwd" placeholder="<?php echo get_phrase('password');?>" required>
					    </div>
					  </div>
					  <div class="form-group">
						 	<div class="col-sm-12">
